...
def seg_and_patch(
    ...
    for i in range(total):
        ...
        if patch:
            ...
            with open('patch_params1.txt', 'a', encoding='utf-8') as f:
                f.write("=" * 50 + "\n")
...
def mp_seg_and_patch(
    ...
    def func(i):
        ...
        patch_time_elapsed = -1  # Default time
        if patch:
            current_patch_params.update({"patch_level": patch_level, "patch_size": step_size, "step_size": step_size, "save_path": patch_save_dir})
            para = {"patch_level": patch_level, "patch_size": patch_size, "step_size": step_size, "save_path": patch_save_dir}
            with open('patch_params1.txt', 'a', encoding='utf-8') as f:
                f.write("=" * 50 + "\n")
                for key, value in para.items():
...
if __name__ == "__main__":
    ...
    with open('args1.txt', 'w', encoding='utf-8') as f:
        # 遍历args的属性并写入
